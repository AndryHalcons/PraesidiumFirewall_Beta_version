#!/usr/bin/env python3
"""
Test: test_interfaces_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `interfaces` cuando se configuran
...
pass_('interfaces optional HTTP read endpoints', 'http_env_present')
