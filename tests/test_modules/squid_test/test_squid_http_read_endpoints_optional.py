#!/usr/bin/env python3
"""
Test: test_squid_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `squid` cuando se configuran
...
pass_('squid optional HTTP read endpoints', 'http_env_present')
