#!/usr/bin/env python3
"""
Test: test_squid_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `squid` a endpoints de validacion en
...
pass_('squid optional invalid payload HTTP', 'http_env_present')
