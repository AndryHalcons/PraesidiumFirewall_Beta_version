#!/usr/bin/env python3
"""
Test: test_dnsmasq_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `dnsmasq` cuando se configuran
...
pass_('dnsmasq optional HTTP read endpoints', 'http_env_present')
