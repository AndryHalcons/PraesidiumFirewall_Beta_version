#!/usr/bin/env python3
"""
Test: test_dnsmasq_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `dnsmasq` a endpoints de validacion en
...
pass_('dnsmasq optional invalid payload HTTP', 'http_env_present')
