...
def main() -> None:
    ...
    endpoint = ROOT / 'web/dashboard/disk_stats.php'
    dashboard = ROOT / 'web/dashboard/dashboard.php'
    script = ROOT / 'web/dashboard/dashboard.js'
    ...
    if not findings:
        data = php_session_include(str(endpoint))
