#!/usr/bin/env python3
"""
Test: test_monitor_backend_static_coverage.py

Objetivo:
    Verificar cobertura estatica de validacion/backend para el modulo `monitor`.
...
check_backend_static_coverage('monitor')
