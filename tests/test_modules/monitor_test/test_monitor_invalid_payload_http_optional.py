#!/usr/bin/env python3
"""
Test: test_monitor_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `monitor` a endpoints de validacion en
...
pass_('monitor optional invalid payload HTTP', 'http_env_present')
