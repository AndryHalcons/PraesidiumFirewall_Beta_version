#!/usr/bin/env python3
"""
Test: test_certificates_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `certificates` cuando se configuran
...
pass_('certificates optional HTTP read endpoints', 'http_env_present')
