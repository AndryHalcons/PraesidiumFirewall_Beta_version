#!/usr/bin/env python3
"""
Test: test_services_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `services` a endpoints de validacion en
...
pass_('services optional invalid payload HTTP', 'http_env_present')
