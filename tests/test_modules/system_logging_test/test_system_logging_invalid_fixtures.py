#!/usr/bin/env python3
"""
Test: test_system_logging_invalid_fixtures.py

Objetivo:
    Verificar fixtures invalidos del modulo para el modulo `system_logging`.
...
check_invalid_fixtures('system_logging')
