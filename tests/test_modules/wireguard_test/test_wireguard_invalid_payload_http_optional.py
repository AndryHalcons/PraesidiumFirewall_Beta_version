#!/usr/bin/env python3
"""
Test: test_wireguard_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `wireguard` a endpoints de validacion en
...
pass_('wireguard optional invalid payload HTTP', 'http_env_present')
