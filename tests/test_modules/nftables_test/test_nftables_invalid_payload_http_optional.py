#!/usr/bin/env python3
"""
Test: test_nftables_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `nftables` a endpoints de validacion en
...
pass_('nftables optional invalid payload HTTP', 'http_env_present')
