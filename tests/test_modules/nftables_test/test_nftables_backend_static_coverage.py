#!/usr/bin/env python3
"""
Test: test_nftables_backend_static_coverage.py

Objetivo:
    Verificar cobertura estatica de validacion/backend para el modulo `nftables`.
...
check_backend_static_coverage('nftables')
