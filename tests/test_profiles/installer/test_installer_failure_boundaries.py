#!/usr/bin/env python3
"""
Test: test_installer_failure_boundaries.py

Objetivo:
    El instalador se detiene ante fallos y deja logs claros.
...
pass_('test_installer_failure_boundaries.py', 'guard_ok; pendiente de harness VM disposable')
