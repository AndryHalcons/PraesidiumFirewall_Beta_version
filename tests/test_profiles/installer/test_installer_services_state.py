#!/usr/bin/env python3
"""
Test: test_installer_services_state.py

Objetivo:
    Servicios esperados tras instalacion.
...
pass_('test_installer_services_state.py', 'guard_ok; pendiente de harness VM disposable')
