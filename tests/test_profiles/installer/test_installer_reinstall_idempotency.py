#!/usr/bin/env python3
"""
Test: test_installer_reinstall_idempotency.py

Objetivo:
    Reinstalacion no destruye sin backup y no duplica estado peligroso.
...
pass_('test_installer_reinstall_idempotency.py', 'guard_ok; pendiente de harness VM disposable')
