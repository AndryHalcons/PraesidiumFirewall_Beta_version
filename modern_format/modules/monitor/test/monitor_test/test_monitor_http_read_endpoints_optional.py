#!/usr/bin/env python3
"""
Test: test_monitor_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `monitor` cuando se configuran
...
pass_('monitor optional HTTP read endpoints', 'http_env_present')
