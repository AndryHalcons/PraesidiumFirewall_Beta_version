#!/usr/bin/env python3
"""
Test: test_certificates_backend_static_coverage.py

Objetivo:
    Verificar cobertura estatica de validacion/backend para el modulo `certificates`.
...
check_backend_static_coverage('certificates')
