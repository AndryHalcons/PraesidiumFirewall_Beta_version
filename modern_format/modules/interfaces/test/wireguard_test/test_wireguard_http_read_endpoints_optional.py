#!/usr/bin/env python3
"""
Test: test_wireguard_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `wireguard` cuando se configuran
...
pass_('wireguard optional HTTP read endpoints', 'http_env_present')
