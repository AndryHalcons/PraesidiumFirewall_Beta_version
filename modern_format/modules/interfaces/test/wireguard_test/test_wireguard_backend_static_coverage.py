#!/usr/bin/env python3
"""
Test: test_wireguard_backend_static_coverage.py

Objetivo:
    Verificar cobertura estatica de validacion/backend para el modulo `wireguard`.
...
check_backend_static_coverage('wireguard')
