#!/usr/bin/env python3
"""
Test: test_interfaces_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `interfaces` a endpoints de validacion en
...
pass_('interfaces optional invalid payload HTTP', 'http_env_present')
