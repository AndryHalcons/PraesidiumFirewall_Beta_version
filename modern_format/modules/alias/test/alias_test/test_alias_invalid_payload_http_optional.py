#!/usr/bin/env python3
"""
Test: test_alias_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `alias` a endpoints de validacion en
...
pass_('alias optional invalid payload HTTP', 'http_env_present')
