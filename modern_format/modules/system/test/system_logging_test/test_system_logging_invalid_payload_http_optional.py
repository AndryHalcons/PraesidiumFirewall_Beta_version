#!/usr/bin/env python3
"""
Test: test_system_logging_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `system_logging` a endpoints de validacion en
...
pass_('system_logging optional invalid payload HTTP', 'http_env_present')
