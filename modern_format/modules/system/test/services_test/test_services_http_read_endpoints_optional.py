#!/usr/bin/env python3
"""
Test: test_services_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `services` cuando se configuran
...
pass_('services optional HTTP read endpoints', 'http_env_present')
