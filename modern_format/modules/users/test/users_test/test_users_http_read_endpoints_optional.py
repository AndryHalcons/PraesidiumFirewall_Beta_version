#!/usr/bin/env python3
"""
Test: test_users_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `users` cuando se configuran
...
pass_('users optional HTTP read endpoints', 'http_env_present')
