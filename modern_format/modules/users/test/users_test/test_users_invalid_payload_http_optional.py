#!/usr/bin/env python3
"""
Test: test_users_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `users` a endpoints de validacion en
...
pass_('users optional invalid payload HTTP', 'http_env_present')
