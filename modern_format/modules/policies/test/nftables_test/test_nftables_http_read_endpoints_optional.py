#!/usr/bin/env python3
"""
Test: test_nftables_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `nftables` cuando se configuran
...
pass_('nftables optional HTTP read endpoints', 'http_env_present')
