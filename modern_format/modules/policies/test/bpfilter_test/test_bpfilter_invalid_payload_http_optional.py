#!/usr/bin/env python3
"""
Test: test_bpfilter_invalid_payload_http_optional.py

Objetivo:
    Enviar fixtures invalidos del modulo `bpfilter` a endpoints de validacion en
...
pass_('bpfilter optional invalid payload HTTP', 'http_env_present')
