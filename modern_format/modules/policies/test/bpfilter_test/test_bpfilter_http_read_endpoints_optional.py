#!/usr/bin/env python3
"""
Test: test_bpfilter_http_read_endpoints_optional.py

Objetivo:
    Probar endpoints de lectura reales del modulo `bpfilter` cuando se configuran
...
pass_('bpfilter optional HTTP read endpoints', 'http_env_present')
