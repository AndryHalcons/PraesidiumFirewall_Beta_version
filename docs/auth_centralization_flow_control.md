...
| 110 | MIGRATED | `web/services/services.php` | html | require_login_page | MANUAL_AUTH |
| 111 | REVIEW | `web/services/services_table/get_delete.php` | json | keep_or_review | CENTRAL_AUTH_USED |
| 112 | MIGRATED | `web/services/services_table/get_forms_from_table.php` | json | require_login_json | MANUAL_AUTH |
| 113 | MIGRATED | `web/services/services_table/get_runtime_status.php` | json | require_login_json | MANUAL_AUTH |
| 114 | MIGRATED | `web/services/services_table/get_table_content.php` | json | require_login_json | MANUAL_AUTH |
...
| 124 | MIGRATED | `web/url_filter/url_filter_table/get_delete_url_filter.php` | json | remove_manual_redundant | CENTRAL_PLUS_MANUAL |
| 125 | MIGRATED | `web/url_filter/url_filter_table/get_file_data.php` | json | require_login_json | MANUAL_AUTH |
| 126 | MIGRATED | `web/url_filter/url_filter_table/get_forms_from_table_url_filter.php` | json | require_login_json | MANUAL_AUTH |
| 127 | MIGRATED | `web/url_filter/url_filter_table/get_save_file_data.php` | json | remove_manual_redundant | CENTRAL_PLUS_MANUAL |
| 128 | MIGRATED | `web/url_filter/url_filter_table/get_table_content_url_filter.php` | json | require_login_json | MANUAL_AUTH |
| 129 | MIGRATED | `web/url_filter/url_filter_table/get_table_structure_url_filter.php` | json | require_login_json | MANUAL_AUTH |
| 130 | MIGRATED | `web/url_filter/url_filter_table/get_update_policy_url_filter.php` | json | remove_manual_redundant | CENTRAL_PLUS_MANUAL |
| 131 | MIGRATED | `web/url_filter/url_filter_table/validation_url_filter.php` | json | require_login_json | MANUAL_AUTH |
| 132 | MIGRATED | `web/url_filter/url_list.php` | html | require_login_page | MANUAL_AUTH |
| 133 | MIGRATED | `web/url_filter/url_listen_ports.php` | html | require_login_page | MANUAL_AUTH |
| 134 | MIGRATED | `web/url_filter/url_network_list.php` | html | require_login_page | MANUAL_AUTH |
| 135 | MIGRATED | `web/url_filter/url_networks_list_profile.php` | html | require_login_page | MANUAL_AUTH |
| 136 | MIGRATED | `web/url_filter/url_policies.php` | html | require_login_page | MANUAL_AUTH |
| 137 | MIGRATED | `web/url_filter/url_port_profile.php` | html | require_login_page | MANUAL_AUTH |
| 138 | MIGRATED | `web/url_filter/url_profile.php` | html | require_login_page | MANUAL_AUTH |
