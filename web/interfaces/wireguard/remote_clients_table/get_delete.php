...
if ($name === '' || !isset($config['remote_clients'][$name])) { wireguard_error('La entrada que intenta borrar no existe o ya fue eliminada.', 'name'); }
wireguard_can_delete('remote_clients', $name, $config);
