...
/*
#############################################################################
   Página de configuración de logs del sistema
   System logging configuration page

   Mantiene la página principal del módulo junto a sus endpoints
   system_logging_table, siguiendo el patrón de carpetas del WebGUI.

   Keeps the module main page next to its system_logging_table endpoints,
   following the WebGUI folder pattern.
#############################################################################
*/
...
<body>
  <section class="cajita-cabecera">
    <h1><?= htmlspecialchars($L['system_logging_title'] ?? $L['sidebar_settings']) ?></h1>
  </section>
